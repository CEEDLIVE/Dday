...
//                if ( packageName != null && packageName.equals("YOUR_APPLICATION_PACKAGE_NAME") ) {
                ...
                if ( packageName != null && packageName.equals("com.example.ceedlive.dday") ) {
...
//                    new ListenActivities(context).start();
                    ...
                    Thread thread = new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            while (!exit) {
                                ...
                                if ( activityName.equals("com.example.ceedlive.dday.activity.LoadingActivity") ) {
        ...
        if ( Intent.ACTION_PACKAGE_ADDED.equals( action ) ) {
            ...
            // do something...
//            if ( intent.getDataString().contains("com.example.ceedlive.dday") ) {
//
//            }

            Log.e(TAG, "ACTION_PACKAGE_ADDED: 앱이 설치되었을 때");
...
//            }
            ...
            Log.e(TAG, "ACTION_PACKAGE_REMOVED : 앱이 삭제되었을 때");
